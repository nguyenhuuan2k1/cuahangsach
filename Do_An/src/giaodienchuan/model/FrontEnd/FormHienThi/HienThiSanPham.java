...
public class HienThiSanPham extends FormHienThi {
    ...
    JTextField txTG = new JTextField(12);
    JTextField txNXB = new JTextField(12);
    ...
    // index
    final int MASP_I = 1, MALSP_I = 2, TEN_I = 3, GIA_I = 4, SOLUONG_I = 5, MATG_I = 6, MANXB_I = 7;
    ...
    public HienThiSanPham() {
        ...
        mtb.setHeaders(new String[]{"STT", "Mã sản phẩm", "Mã loại", "Tên", "Đơn giá (nghìn)", "Số lượng", "Hình ảnh", "Trạng thái", "Mã tác giả", "Mã nhà xuất bản"});
        ...
        cbTypeSearch = new JComboBox<>(new String[]{"Tất cả", "Mã sản phẩm", "Mã loại", "Tên", "Đơn giá (nghìn)", "Số lượng", "Trạng thái", "Mã tác giả", "Mã nhà xuất bản"});
        ...
        txTG.setBorder(BorderFactory.createTitledBorder("Tác giả"));
        txNXB.setBorder(BorderFactory.createTitledBorder("Nhà xuất bản"));
        ...
        plTextField.add(txTG);
        plTextField.add(txNXB);
        ...
        if (masp != null) {
            ...
            for (SanPham sp : qlspBUS.getDssp()) {
                if (sp.getMaSP().equals(masp)) {
                    ...
                    txTG.setText(tg + " - " + sp.getMaTG());
                    txNXB.setText(nxb + " - " + sp.getMaNXB());
