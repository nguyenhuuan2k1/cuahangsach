...
//        tabs.addTab("Thống kê ver2", getIcon("icons8_company_30px.png"), tk2);
        ...
        tabs.addTab("Sản phẩm", getIcon("icons8_dossier_folder_30px.png"), null);
...
class ThongKe_Hoang extends JPanel {
    ...
    public ThongKe_Hoang() {
        ...
        btnChonSanPham.addActionListener((ae) -> {
            ChonSanPhamForm cnv = new ChonSanPhamForm(txSanPham, null, null, null, null, null, null);
        });
    ...
    private void setDataToPanelTong() {
        ...
        plThongKeSoLuong.add(getJPanelTong("SẢN PHẨM", "icons8-add-book-100.png", qlspBUS.getDssp().size(), Color.BLUE));
