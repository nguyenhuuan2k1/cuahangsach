...
class ChiTietQuyenForm extends JPanel {
    ...
    public ChiTietQuyenForm() {
        ...
        dsPanel.add(new PanelChooseQuyen("Thể loại", type, new String[]{"xemLoaiSanPham", "qlLoaiSanPham"}));
        dsPanel.add(new PanelChooseQuyen("Tác giả", type, new String[]{"xemTacGia", "qlTacGia"}));
        dsPanel.add(new PanelChooseQuyen("Nhà xuất bản", type, new String[]{"xemNhaXuatBan", "qlNhaXuatBan"}));
