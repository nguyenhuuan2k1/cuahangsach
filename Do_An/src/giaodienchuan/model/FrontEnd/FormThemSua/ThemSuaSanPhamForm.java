...
import giaodienchuan.model.FrontEnd.FormChon.ChonTacGiaForm;
import giaodienchuan.model.FrontEnd.FormChon.ChonNhaXuatBanForm;
...
public class ThemSuaSanPhamForm extends JFrame {
    ...
    private void btnThemMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlspBUS.add(masp, maloai, ten, dongia, soluong, url, trangthai, matg, manxb)) {
    ...
    private void btnSuaMouseClicked() {
        if (checkEmpty()) {
            ...
            if (qlspBUS.update(masp, maloai, ten, dongia, soluong, url, trangthai, matg, manxb)) {
    ...
    private void btnChonTGMouseClicked() {
        ChonTacGiaForm ctg = new ChonTacGiaForm(txMatg); // truyền vào textfield
    }
    
    private void btnChonNXBMouseClicked() {
        ChonNhaXuatBanForm cnxb = new ChonNhaXuatBanForm(txManxb); // truyền vào textfield
    }
