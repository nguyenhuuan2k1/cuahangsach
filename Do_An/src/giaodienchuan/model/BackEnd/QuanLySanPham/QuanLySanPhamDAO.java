...
public class QuanLySanPhamDAO {
        ...
        try {
            ...
            if (r != null) {
                while (r.next()) {
                    ...
                    String matg = r.getString("MaTG");
                    String manxb = r.getString("MaNXB");
                    dssp.add(new SanPham(masp, loaisp, tensp, dongia, soluong, url, trangthai,matg,manxb));
                }
            }
    ...
    public Boolean add(SanPham sp) {
        qlspConnection = new ConnectionDB();
        Boolean ok = qlspConnection.sqlUpdate("INSERT INTO `sanpham` (`MaSP`, `MaLSP`, `TenSP`, `DonGia`, `SoLuong`, `HinhAnh`, `TrangThai`, `MaTG`, `MaNXB`) VALUES ('"
                + sp.getMaSP() + "', '"
                + sp.getMaLSP() + "', '"
                + sp.getTenSP() + "', '"
                + sp.getDonGia() + "', '"
