...
public class QuanLySanPhamBUS {
    ...
    public String[] getHeaders() {
        return new String[]{"Mã sản phẩm", "Mã loại", "Tên", "Đơn giá", "Số lượng", "Trạng thái", "Mã tác giả", "Mã nhà Xuất Bản"};
    }
    ...
    public Boolean add(String masp, String malsp, String tensp, float dongia, int soluong, String filename, int trangthai, String matg, String manxb) {
        SanPham sp = new SanPham(masp, malsp, tensp, dongia, soluong, filename, trangthai,matg,manxb);
        return add(sp);
    }
    ...
    public Boolean update(String masp, String malsp, String tensp, float dongia, int soluong, String filename, int trangthai, String matg, String manxb) {
        Boolean ok = qlspDAO.update(masp, malsp, tensp, dongia, soluong, filename, trangthai, matg, manxb);
